$(function(){
    ...
    var render = function(callback){
        ...
        getProductListData($.extend({
            ...
            /*渲染商品列表*/
            if(currPage == 1){
                $('.zm_product').html(template('productTpl',data));
            }else{
                $('.zm_product').append(template('productTpl',data));
            }
    ...
    $('.search_btn').on('tap',function(){
        ...
        /*显示加载*/
        $('.zm_product').html('<div class="loading"><span class="mui-icon mui-icon-spinner"></span></div>');
        /*当前页码*/
        currPage = 1;
        /*渲染*/
        render();
